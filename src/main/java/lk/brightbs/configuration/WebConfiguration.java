        ...
        //service authentication matching
         http.authorizeHttpRequests(auth -> {
            ...
            .requestMatchers("/dashboard").hasAnyAuthority("Admin" , "Manager" , "Cashier")
                    .requestMatchers("/getPrivilegeByUserModule/**").hasAnyAuthority("Admin" , "Manager" , "Cashier")
            ...
            .requestMatchers("/customer/**").hasAnyAuthority("Admin" , "Manager" , "Cashier")
                    ...
                    .requestMatchers("/priceRequest/**").hasAnyAuthority("Admin" , "Manager")
                    .requestMatchers("/addPriceList/**").hasAnyAuthority("Admin" , "Manager")
                    .requestMatchers("/purchaseOrders/**").hasAnyAuthority("Admin" , "Manager")
                    .requestMatchers("/grn/**").hasAnyAuthority("Admin" , "Manager")
                    .requestMatchers("/supplierPayments/**").hasAnyAuthority("Admin" , "Manager")
                    .requestMatchers("/loyaltycustomer/**").hasAnyAuthority("Admin" , "Manager" , "Cashier")

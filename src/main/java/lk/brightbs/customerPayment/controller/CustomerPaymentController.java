...
public class CustomerPaymentController {
    ...
    //Autowired - awashya method automatically build karala method body liyala api add karana veriable ekata ewa assing karala denawa (customerPaymentDao instance ekak hadala denawa)
    @Autowired 
    ...
    //request mapping for load customer payment ui url - /customerPayment
	@RequestMapping("/customerPayment") //request eka meka awoth yata function eka run karanawa
	public ModelAndView getCustomerPaymentUI(){
      ...
      //load customerPayments all data
   @GetMapping(value = "/customerPayment/alldata" , produces = "application/json")
   public List<CustomerPayment> findAllData(){// check user authentication and authorization

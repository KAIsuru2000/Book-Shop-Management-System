...
public class BrandController {
    ...
    // request mapping for get item with supplier url -
    // "/brand/getListBySupply?supplierid="
    // mehidee supplierid eka pathvariable widiyata gannawa path veriable eka lesa
    // pass wana id ekata "supplierid" lesa bawitha karai
    ...
    // // request mapping for get brand without supply url -
    // "/brand/listwihoutsupply"
    // @GetMapping(value = "/brand/listwihoutsupply" , params = {"supplierid"} ,
    // produces = "application/json")
    // public List<Brand> getListWithoutSupply(@RequestParam("supplierid") Integer
    // supplierid) {
    ...
    // userPrivilegeController.getPrivilegeByUserModule(auth.getName(), "ITEM");
    ...
    // load brand whithout supplier data
    @GetMapping(value = "/brand/getBrandListWithoutSupplier", produces = "application/json")
    public List<Brand> getBrandListWithoutSupplier() {
        return brandDao.getBrandListWithoutSupplier();
    }
